...
export const WORK_ITEM_COLUMNS: Record<WorkItemColumnKey, WorkItemColumnMeta> = {
  ...
  category:  { label: '작업 분류',     defaultWidth: 130, defaultVisible: true,  hideable: true, sortKey: 'category' },
  ...
  actions:   { label: '작업',          defaultWidth: 110, defaultVisible: true,  hideable: false, headerAlign: 'center' },
  ...
  content:   { label: '작업 내용',     defaultWidth: 280, defaultVisible: false, hideable: true },
  result:    { label: '작업 결과',     defaultWidth: 280, defaultVisible: false, hideable: true },
