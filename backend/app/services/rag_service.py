...
Citation 형태 (JSONB 저장·API 응답·프론트 딥링크 공용):
    {"title", "source_type": "work_guide"|"work_item"|"ops_note",
...
async def retrieve(
    ...
    wanted = set(source_types or ("work_guide", "work_item", "ops_note"))
...
def build_reference_block(citations: list[dict]) -> str:
    ...
    type_labels = {"work_guide": "작업 가이드", "work_item": "업무 이력", "ops_note": "운영 노트"}
